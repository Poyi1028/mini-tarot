...
export const EASE: Record<'out' | 'inOut' | 'reveal', Bezier> = {
...
export const DUR: Record<'fast' | 'base' | 'slow', number> = {
  fast: 0.3,
  base: 0.7,
  slow: 1.1,
};
...
export const SPRING_FLOAT: Transition = { type: 'spring', stiffness: 70, damping: 15, mass: 0.7 };
...
export const SPRING_SHUFFLE: Transition = { type: 'spring', stiffness: 90, damping: 13, mass: 0.5 };
